        ...
        <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
            ...
            <tbody id="list_todo">
                <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="row_todo_<?php echo e($todo->id); ?>">
                        <td width="20"><?php echo e($loop->iteration); ?></td>
                        <td><?php echo e($todo->name); ?></td>
                        <td width="150">
                            <button type="button" id="edit_todo" data-id="<?php echo e($todo->id); ?>"
                                class="btn btn-sm btn-info ml-1">Edit</button>

                            <button type="button" id="delete_todo" data-id="<?php echo e($todo->id); ?>"
...
<?php /**PATH C:\laragonwamp\www\ajax-crud-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>